		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						<!-- <h2 class="title"><a href="#">卖家注册</a></h2> -->
						<div class="entry">
						    <form action="<%=path %>/maijiaReg.action" name="form1" method="post">
								 <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
									<tr>
										<td width="14%" height="30" align="right" bgcolor="#F9F9F9" style="font-size: 11px;">
											账号：
										</td>
									...
									<tr>
										...
										<td bgcolor="#FFFFFF">
											&nbsp;
											<input type="password" name="loginpw" style="width: 250px;"/>
										</td>
									</tr>
									<tr>
										<td height="30" align="right" bgcolor="#F9F9F9" style="font-size: 11px;">
										...
										<td bgcolor="#FFFFFF">
											&nbsp;
											<input type="text" name="xingming" style="width: 250px;"/>
										</td>
									</tr>
									<tr>
										<td height="30" align="right" bgcolor="#F9F9F9" style="font-size: 11px;">
										...
										<td bgcolor="#FFFFFF">
											&nbsp;
											<input type="text" name="xingbie" size="50" style="width: 250px;"/>
										</td>
									</tr>
									<tr>
										<td height="30" align="right" bgcolor="#F9F9F9" style="font-size: 11px;">
										...
										<td bgcolor="#FFFFFF">
											&nbsp;
											<input type="text" name="dianhua" style="width: 250px;"/>
										</td>
									</tr>
									<tr>
										<td height="30" align="right" bgcolor="#F9F9F9" style="font-size: 11px;">
										...
										<td bgcolor="#FFFFFF">
											&nbsp;
											<input type="text" name="zhuzhi" style="width: 250px;"/>
										</td>
									</tr>
									<tr>
