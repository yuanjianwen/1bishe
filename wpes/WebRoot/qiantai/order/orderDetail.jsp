  ...
  <body class="body" leftmargin="0" rightmargin="0">
     <table cellspacing="1" cellpadding="0" width="100%" border="0" bgcolor="#F7F3F7">
          <tr height="26">
              ...
              <td class="blackTitle" align="center">是否受理</td>
              <!-- <td class="blackTitle" align="center">评论</td> -->
          </tr>
		  ...
		  <tr class="text" align="center" bgcolor="#FFFFFF">
			  ...
			  <td><s:property value="#orderItem.zt"/></td>
			  <%-- <td>
			      <a href="<%=path %>/qiantai/pingjia/pingjiaAdd.jsp?goodsId=<s:property value='#orderItem.goods.goodsId'/>" >评价</a>
			  </td> --%>
		  </tr>
		  </s:iterator>
  	</table>
